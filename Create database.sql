...
CREATE DATABASE [ClimaTempoSimples]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ClimaTempoSimples', FILENAME =  N'C:\Users\didig\OneDrive\Área de Trabalho\database\ClimaTempoSimples.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ClimaTempoSimples_log', FILENAME = N'C:\Users\didig\OneDrive\Área de Trabalho\database\ClimaTempoSimples_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
